...
USER root
RUN apt-get update
RUN apt-get install ssh curl wget nginx-full nano bash tmux zip unzip screen ca-certificates python3 python3-pip git locales cmake ffmpeg redis-server supervisor iputils-ping -y
